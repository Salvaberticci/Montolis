    ...
    <main class="p-6">
        ...
        <div id="product-grid" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                ...
                echo "<span class='text-2xl font-bold text-purple-600'>Al Mayor (4+): &#36;{$wholesale_price}</span>";
                echo "<span class='text-lg font-semibold text-green-800'>Al Detal: &#36;{$sale_price}</span>";
                echo "</div>";
                echo "</div>";
